...
const FOOD_DB = {
  ...
  '薯條':      { calories: 312, protein: 3.4,  carbs: 41.4, fat: 15.0 },
  '炒飯':      { calories: 175, protein: 4.5,  carbs: 30.0, fat: 4.5  },
  '炒麵':      { calories: 160, protein: 5.2,  carbs: 27.5, fat: 3.8  },
  '義大利麵':  { calories: 157, protein: 5.8,  carbs: 30.9, fat: 0.9  },
  '水餃':      { calories: 168, protein: 7.2,  carbs: 24.5, fat: 4.6  },
  // ── 蛋類 ──
  ...
  '乳酪':      { calories: 402, protein: 25.0, carbs: 1.3,  fat: 33.0 },
  // ── 堅果油脂 ──
